							...
							<div className="swiper-wrapper">
								<SwiperSlide>
									<div className="item-banner-slide banner-1">
										<div className="container">
											...
											<h1 className="mt-20 mb-20 color-white">No Car ? No Worries</h1>
											<h6 className="color-white heading-6-medium pb-lg-0 pb-4">
												Rent a car anywhere from Nepal. <br />
											Free Pickup and Drop All Over Nepal</h6>
								...
								<SwiperSlide>
									<div className="item-banner-slide banner-2">
										<div className="container">
											<span className="btn background-brand-2 px-3 py-3 rounded-12 text-sm-bold text-dark">Nepal's First Car Rental Service</span>
