						...
						<div className="col-lg-6 mb-30">
							<div className="d-flex align-items-center justify-content-center justify-content-lg-end popular-categories">
								...
								<div className="dropdown dropdown-filter">
									...
									<ul className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownCategory">
										<li><Link className="dropdown-item active" href="#">Rs 1000 - Rs 10,000</Link></li>
										<li><Link className="dropdown-item" href="#">Rs 10,000 - Rs 50,000</Link></li>
										<li><Link className="dropdown-item" href="#">Rs 50,000 - Rs 1,00,000</Link></li>
									</ul>
								</div>
							</div>
						</div>
											...
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												...
												<div className="card-program">
													...
													<div className="endtime border-top pt-4">
														<div className="card-price">
															<p className="text-md-medium neutral-500 me-2">From</p>
															<h6 className="heading-6 neutral-1000">Rs 350</h6>
														</div>
														<div className="card-button"><Link className="btn btn-gray" href="/cars-details-1">Book Now</Link></div>
													</div>
												</div>
											...
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												...
												<div className="card-program">
													...
													<div className="endtime border-top pt-4">
														<div className="card-price">
															<p className="text-md-medium neutral-500 me-2">From</p>
															<h6 className="heading-6 neutral-1000">Rs 25000</h6>
														</div>
														<div className="card-button"><Link className="btn btn-gray" href="/cars-details-1">Book Now</Link></div>
													</div>
												</div>
											...
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												...
												<div className="card-program">
													...
													<div className="endtime border-top pt-4">
														<div className="card-price">
															<p className="text-md-medium neutral-500 me-2">From</p>
															<h6 className="heading-6 neutral-1000">Rs 5000</h6>
														</div>
														<div className="card-button"><Link className="btn btn-gray" href="/cars-details-1">Book Now</Link></div>
													</div>
												</div>
											...
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												...
												<div className="card-program">
													...
													<div className="endtime border-top pt-4">
														<div className="card-price">
															<p className="text-md-medium neutral-500 me-2">From</p>
															<h6 className="heading-6 neutral-1000">Rs 3500</h6>
														</div>
														<div className="card-button"><Link className="btn btn-gray" href="/cars-details-1">Book Now</Link></div>
													</div>
												</div>
											...
											<div className="card-info p-4 mt-0 position-relative end-0 h-100 w-lg-55 rounded-12">
												...
												<div className="card-program">
													...
													<div className="endtime border-top pt-4">
														<div className="card-price">
															<p className="text-md-medium neutral-500 me-2">From</p>
															<h6 className="heading-6 neutral-1000">Rs 4000</h6>
														</div>
														<div className="card-button"><Link className="btn btn-gray" href="/cars-details-1">Book Now</Link></div>
													</div>
												</div>
