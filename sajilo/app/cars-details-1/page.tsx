											...
											<div className={isAccordion == 2 ? "collapse" : "collapse show"} id="collapseItinerary">
												<div className="card card-body">
													<ul className="list-checked-green">
														...
														<li>Collision Damage Waiver with Rs 70,000 deductible</li>
										...
										<div className="content-booking-form">
												...
												<div className="box-tickets">
													...
													<div className="line-booking-tickets">
														...
														<div className="include-price">
															<p className="text-md-bold neutral-1000">Rs 25.00</p>
														</div>
													</div>
													<div className="line-booking-tickets">
														<div className="item-ticket">
														...
														<div className="include-price">
															<p className="text-md-bold neutral-1000">Rs 32.00</p>
														</div>
													</div>
													<div className="line-booking-tickets">
														<div className="item-ticket">
													...
													<div className="line-booking-tickets">
														...
														<div className="include-price">
															<p className="text-md-bold neutral-1000">Rs 52.00</p>
														</div>
													</div>
												</div>
											</div>
											<div className="item-line-booking last-item pb-0">
												...
												<div className="line-booking-right">
													<p className="text-xl-bold neutral-1000">Rs 124.00</p>
												</div>
											</div>
											<div className="item-line-booking last-item pb-0">
											...
											<div className="box-agent-support border-bottom pb-3 mb-3">
												<div className="card-author">
													...
													<div className="card-author-info">
														<p className="text-lg-bold neutral-1000">Lukesh Raj</p>
														<p className="text-sm-medium neutral-500">Patan Hospital, Kathmandu, Nepal</p>
													</div>
												</div>
											</div>
