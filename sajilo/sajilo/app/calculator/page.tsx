							...
							<div className="row">
								...
								<div className="col-lg-7 mt-lg-0 mt-4">
									<div className="d-flex flex-md-row flex-column align-items-center justify-content-center gap-3 mb-30">
										<div>
											<img className="rounded-12" src="/assets/imgs/cta/cta-11/img-1.png" alt="Sajilo" />
										</div>
										<div>
											<img className="rounded-12" src="/assets/imgs/cta/cta-11/img-2.png" alt="Sajilo" />
										</div>
									</div>
								</div>
							</div></div></section>
								...
								<div className="row align-items-center flex-column-reverse flex-lg-row">
									<div className="col-lg-6">
										<div className="card-image d-inline-block position-relative mb-100">
											<img className="rounded-12" src="/assets/imgs/cta/cta-11/img-3.png" alt="Sajilo" />
											<img className="position-absolute top-100 start-100 translate-middle d-none d-md-block" src="/assets/imgs/cta/cta-11/img-car.png" alt="Sajilo" />
										</div>
									</div>
												...
												<div className="row">
													<div className="col-lg-6">
														<div className="form-group">
															...
															<input className="form-control" type="text" placeholder="$20,000" value={price.toLocaleString()} onChange={handlePriceChange} />
														</div>
													</div>
													<div className="col-lg-6">
														<div className="form-group">
													...
													<div className="col-lg-6">
														<div className="form-group">
															...
															<input className="form-control" type="text" placeholder="$12,000" value={downPayment.toLocaleString()} onChange={handleDownPaymentChange} />
														</div>
													</div>
													<div className="row py-4">
														...
														<div className="col-md-7 col-4 d-flex flex-column gap-1 align-items-end align-items-md-start">
															<p className="text-sm-bold neutral-1000">${downPayment.toLocaleString()}</p>
															<p className="text-sm-bold neutral-1000">${loanAmount.toLocaleString()}</p>
															<p className="text-sm-bold text-primary-dark">${monthlyPayment.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</p>
														</div>
													</div>
