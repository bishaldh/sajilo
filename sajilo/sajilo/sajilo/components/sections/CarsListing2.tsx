					...
					<div className="row pt-30">
							...
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-1.png" alt="Sajilo" />
									</Link>
								</div>
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.2s">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-2.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
									...
									<div className="card-program">
										<div className="card-location">
											<p className="text-location text-sm-medium neutral-500">Patan, Lalitpur
											</p>
										</div>
										<div className="card-facitlities">
											<p className="card-miles text-md-medium">25,100 miles</p>
