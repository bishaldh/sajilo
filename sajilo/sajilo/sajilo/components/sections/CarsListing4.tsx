					...
					<div className="row pt-30 wow fadeInUp">
							...
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-1.png" alt="Care" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									...
									<div className="card-program">
										<div className="card-location">
											<p className="text-location text-sm-medium neutral-500">Kathmandu, Nepal</p>
										</div>
										...
										<div className="endtime">
											<div className="card-price">
												<h6 className="text-lg-bold neutral-1000">NPR 15,000</h6>
						...
						<div className="col-lg-3 col-md-6">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-5.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
									...
									<div className="card-program">
										<div className="card-location">
											<p className="text-location text-sm-medium neutral-500">Patan, Lalitpur</p>
										</div>
										<div className="card-facitlities">
											<p className="card-miles text-md-medium">25,100 miles</p>
											<p className="card-gear text-md-medium">Automatic</p>
						...
						<div className="col-lg-3 col-md-6">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-6.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-7.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-8.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-9.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-10.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/cars-details-2">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-11.png" alt="Sajilo" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
