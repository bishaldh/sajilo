								...
								<div className="swiper-wrapper">
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-6/car-1.png" alt="Sajilo" />
												</Link>
											</div>
											<div className="card-info">
												...
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Bhojpur, Nepal</p>
													</div>
													...
													<div className="endtime">
														<div className="card-price">
															...
															<h6 className="heading-6 neutral-1000">NPR 15,000</h6>
														</div>
										...
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-6/car-2.png" alt="Carento" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
												...
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Boudha, Kathmandu</p>
													</div>
													<div className="card-facitlities">
														<p className="card-miles text-md-medium">25,100 miles</p>
														<p className="card-gear text-md-medium">Automatic</p>
													...
													<div className="endtime">
														<div className="card-price">
															<p className="text-md-medium neutral-500 me-2">From</p>
															<h6 className="heading-6 neutral-1000">NPR 498.25</h6>
														</div>
														<div className="card-button"><Link className="btn btn-gray" href="/cars-details-1">Book Now</Link></div>
													</div>
												</div>
