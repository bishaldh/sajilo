  ...
  const cars = [
    {
      ...
      features: ['Bluetooth', 'Air Conditioning', 'GPS', 'USB Charger'],
    },
    {
      make: 'Suzuki',
      model: 'Swift',
    ...
    },
    {
      ...
      features: ['Bluetooth', 'Air Conditioning', 'GPS', 'Rear Camera', 'Sunroof'],
    },
    {
      make: 'Toyota',
      model: 'Hiace',
    ...
    },
    {
      ...
      features: ['Leather Seats', 'Sunroof', 'Touchscreen', 'Android Auto', 'Apple CarPlay'],
    },
  ];
